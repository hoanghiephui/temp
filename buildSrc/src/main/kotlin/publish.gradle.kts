        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/hoanghiephui/temp/")
                    ...
                    developers {
                        developer {
                            id.set("hoanghiephui")
                            name.set("hoanghiephui")
                        }
                    }
                    scm {
                        connection.set("scm:git:git://github.com/hoanghiephui/temp.git")
                        developerConnection.set("scm:git:ssh://github.com/hoanghiephui/temp.git")
                        url.set("https://github.com/hoanghiephui/temp/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/hoanghiephui/temp/issues")
                    }
                }
            }
        }
